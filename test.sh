...
mpirun --oversubscribe -n 4 ./mmult 2>&1 | tee app.out
...
mpirun --oversubscribe -n 4 python3 ./mmult.py -k C &> app.out
juLog -name="run_c_buffer_overflow" -class="py_dbg" check_output "AddressSanitizer: heap-buffer-overflow"
mpirun --oversubscribe -n 4 python3 ./mmult.py -k F90 &> app.out
